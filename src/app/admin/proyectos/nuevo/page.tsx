          ...
          <>
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              ...
              <div className="space-y-4">
                ...
                {formData.pdfUrl && (
                  <div className="space-y-4">
                    {/* Mostrar archivo actual con botón de eliminar */}
                    <div className="bg-gray-50 rounded-lg p-3">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-sm font-medium text-gray-700">Archivo PDF cargado</p>
                            <p className="text-xs text-gray-500">
                              {formData.pdfUrl.split('/').pop()?.substring(0, 30)}...
                            </p>
                          </div>
                        </div>
                        <button
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-white p-4 rounded-lg border border-gray-200">
                      ...
                      <div className="space-y-3">
                        ...
                        {tab.pdfUrl && (
                          <div className="space-y-3">
                            {/* Mostrar URL del PDF actual con botón de eliminar */}
                            <div className="bg-gray-50 rounded-lg p-3">
                              <div className="flex justify-between items-start mb-2">
                                ...
                                <button
                                  type="button"
                                  onClick={() => updateTab(activeTabIndex, 'pdfUrl', '')}
                                  className="px-2 py-1 bg-red-600 text-white text-xs rounded hover:bg-red-700 ml-2"
                                >
